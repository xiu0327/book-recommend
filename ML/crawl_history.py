...
if response.status_code == 200:
    ...
    for page in range(1, page_num + 1):
        ...
        if response.status_code == 200:
            ...
            print('loan/history table load error' + response.status_code)

        if not book_list: print('login error')

    if book_list: print(book_list)

else:
    print('loan/history page load error' + response.status_code)
